    ...
    <main>
      <div className={`wrap ${styles.wrap}`}>
        <div className={styles.explanation}>
          ...
          <br/>
          <p className='subtxt'>회원정보에 등록한 휴대전화번호와 입력한 휴대전화번호가 일치하여야 인증번호를 받을 수 있습니다.</p>
        </div>
        <form className={styles.search_form}>
          ...
          <div className={`${
            authCode.status === 'none' ? styles.none : ''
          }`}>
            <Label
              title='인증번호'
              target=''
        ...
        <div className={`${styles.result} ${result.view ? '' : styles.none}`}>
          {result.userData === null
            ?
            <div>
              <p>고객님의 정보와 일치하는 아이디가 없습니다.</p><br/><br/>
              <p>사회복지 커리어 관리<br/>NEEDU와 함께 지금부터 시작하세요!</p>
              <div>
